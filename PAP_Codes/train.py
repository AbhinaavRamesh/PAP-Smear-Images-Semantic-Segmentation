...
parser.add_argument('--dataset', type=str, default="PAP", help='Dataset you are using.')
...
parser.add_argument('--num_val_images', type=int, default=913 , help='The number of images to used for validations')
